...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleResourceMismatchException(ResourceMismatchException exception, HttpServletRequest request){
        log.warn("Resource mismatch: {}", exception.getMessage());
        return buildErrorResponse(exception.getMessage(), null, request.getRequestURI(), HttpStatus.UNAUTHORIZED);
    }
